...
%configure \
	...
	--with-libssl-prefix=%{_prefix} --with-libz-prefix=%{_prefix} \
	--disable-silent-rules --disable-static --enable-shared
%{make_build}
...
# Fedora seems to have problems with this, we don't somehow
...
%{_libdir}/libssh2.so
%exclude %{_libdir}/libssh2.a
%{_libdir}/pkgconfig/libssh2.pc


%changelog
* Thu Apr 30 2020 Calvin Buckley <calvin@cmpct.info> - 1.9.0-6qsecofr
- IBM i adaption of Fedora package
