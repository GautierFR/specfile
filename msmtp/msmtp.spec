...
Patch0:	msmtp-vasprintf.diff

BuildRequires:	openssl-devel
BuildRequires:	libidn2-devel
BuildRequires:	libintl-devel, gettext-runtime
...
%build
%configure \
	LDFLAGS="-lutil -Wl,-blibpath:%{_libdir}:/QOpenSys/usr/lib -L%{_libdir}" \
...
%post
%{_bindir}/update-alternatives --install %{_bindir}/sendmail mta %{_bindir}/msmtp 40 \
  --slave %{_prefix}/lib/sendmail mta-sendmail %{_bindir}/msmtp \
  --slave %{_mandir}/man8/sendmail.8 mta-sendmailman %{_mandir}/man1/msmtp.1 \
  --slave %{_bindir}/mailq mta-mailq %{_bindir}/msmtp \
  --slave %{_mandir}/man1/mailq.1 mta-mailqman %{_mandir}/man1/msmtp.1

%postun
if [ $1 -eq 0 ] ; then
	%{_bindir}/update-alternatives --remove mta %{_bindir}/msmtp
fi
...
%{_infodir}/%{name}.info*
%{_mandir}/man1/%{name}*.1*
%{_datadir}/locale/*/LC_MESSAGES/msmtp.mo

%changelog
* Fri May 15 2020 Calvin Buckley <calvin@cmpct.info> - 1.8.10-1qsecofr
- Bump
- PASE
