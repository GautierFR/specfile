...
# XXX: If we --enable-libs, add the typical sludge required for them
autoreconf -fiv .
...
#%check
# it passes but will take its sweet time
#make tests
...
%changelog
* Fri May 22 2020 Calvin Buckley <calvin@cmpct.info> - 1.3-0qsecofr
- PASE
- Bump
